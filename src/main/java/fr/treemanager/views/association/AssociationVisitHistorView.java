...
public class AssociationVisitHistorView extends AbstractAssociationView implements Initializable {
    List<Visit> visits;

    @FXML
    private ScrollPane visitHistoryScrollPane;

    public AssociationVisitHistorView(AssociationController controller) {
        super(controller);
    }
